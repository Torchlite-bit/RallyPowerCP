> **⚠️ SUPERSEDED (written at v0.3.2).** Kept for history. The current plan lives in `CLAUDE.md` ("Next milestone") and `docs/DESIGN_ALLCLASSES.md`; progress is in `CHANGELOG.md`.
